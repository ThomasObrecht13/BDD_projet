...
public class SimpleJdbcDaoTest {
    ...
    public void test() throws DaoException {
        ...
        Ville ville = new Ville(1, "bart",30000);
        createVille(ville);
        System.out.println("***** Liste des Ville : ");
        findAllVille();
        System.out.println("***** Modification Ville :");
        Ville new_ville = new Ville(1,"veauj",25000);
        ...
        Vehicule vehicule = new Vehicule(1,"2020-12-10","bon",45,20,0,0,0,0,0);
        createVehicule(vehicule);
        System.out.println("***** Liste des Vehicule : ");
        findAllVehicule();
        System.out.println("***** Modification Vehicule :");
        Vehicule new_vehicule = new Vehicule(1,"2020-12-20","mauvais",50,25,0,0,0,0,0);
