...
public class SimpleJdbcDaoTest {
    ...
    public void test() throws DaoException {
        ...
        Client client = new Client(1,"client2","adresse_test",90000,0);
        createClient(client);
        System.out.println("***** Liste des Client : ");
        findAllClient();
        System.out.println("***** Modification Client :");
        Client new_client = new Client(1,"client2_modif","adresse_test_modif",90000,0);
        ...
        Contrat contrat = new Contrat(2,"2020-08-15","2020-09-14",10,20,0,0,0);
        createContrat(contrat);
        System.out.println("***** Liste des Contrat : ");
        findAllContrat();
        System.out.println("***** Modification Contrat :");
        Contrat new_contrat = new Contrat(2,"2020-09-16","2020-11-24",11,22,0,1,1);
